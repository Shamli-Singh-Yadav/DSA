...
If an array has 5 elements, loop runs 5 times
If array has 100 elements, loop runs 100 times
...
## In Simple Words: 
Time complexity shows how execution time grows with input size, and space complexity shows how extra memory usage grows with input size.